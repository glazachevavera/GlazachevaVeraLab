...
- Данную задачу можно свести к задаче о поиске количества невлезших мусорных пакетах в контейнер. 
...
3. **Поиск колическва невлезших пакетов**
   Выясняем ответна вопрос: "Влезает ли пакет в кантейнер на данный момент или нет?",  после последовательных ответов на вопросы про первый, второй и третий пакеты, выяснить количество ответов нет, оно и будет ответом на задачу.
